...
The "Great American Coffee Taste Test" data set is compiled of survey results that were filled out by participants of a taste test, hosted in part by a coffee company Cometeer. The survey includes questions about coffee drinking habits, coffee preferences, individual taste test results for each of the 4 provides coffees, and individual demographics.

![Image credit: Cometeer, cometeer.com.](images/cometeer_logo.png){fig-align="center" width="500"}
...
p4 <- coffee_survey_percentage %>% 
  ...
  geom_col(data = filter(coffee_survey_percentage, 
                         response_value %in% c("More than 4", "4")), 
           aes(y = percent_answers)) +
  ...
  facet_grid(explanatory ~ ., 
             ...
             labeller = labeller(explanatory = exp.labs)) +
  labs(
    title = "Trends Among Coffee Drinkers",
    x = NULL,
...
p <- coffee_survey_count_plot1 %>%  
  ...
  geom_label_repel( 
    ...
    show.legend = FALSE) +
  labs(
    title = "Distribution of Daily Cups of Coffee \n "
  ) +
  theme_void() +
  theme(
...
Average amount of coffee ranges between 1 and 3 cups for each group
...
- Average cups of coffee ranges between 1 and 3 cups for each group
- Drinking less than 1 cup of coffee is more common among those less than 24 years old, no kids, and unemployed.
- Drinking more coffee is more common among those 45 years old and older, with many kids, and retired.
