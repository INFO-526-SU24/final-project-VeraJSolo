...
Coffee consumption in the U.S. varies significantly, influenced by lifestyle factors. Analysis of "The Great American Coffee Taste Test" data set reveals interesting insights on trends regarding coffee drinking habits among those that drink coffee. It was observed that the average daily coffee intake is 1 or 2 cups of coffee. Older individuals,those with more children, and retired or full-time employees are more likely to 4 or more cups of coffee, while younger individuals, those with no children, or work part-time at the most are more likely to drink less than 1 cup of coffee per day. These findings highlight correlations between lifestyle and working conditions and coffee drinking habits, however more research should be dedicated to explore any causal relationships, especially between multiple explanatory variables.
...
coffee_survey_count_plot1 %>%  
  ...
  geom_label_repel( 
    ...
    show.legend = FALSE) +
  labs(
    title = "Plot 1. Distrubution of Daily Cups of Coffee \nAmong Responses \n ",
    caption = "Source: 'The Great American Coffee Taste Test' \n Retreived from TidyTuesday 2024"
  ) +
  theme_void() +
  theme(
...
coffee_survey_stats %>% 
  ...
  labs(
    ...
    y = NULL,
    title = "Plot 2. Distrubution of Daily Cups of Coffee \nAmong Explanatory Variables",
    caption = "Source: 'The Great American Coffee Taste Test' \n Retreived from TidyTuesday 2024"
  ) +
  theme_minimal() +
  theme(
...
coffee_survey_percentage %>% 
  ...
  facet_grid(explanatory ~ ., 
             ...
             labeller = labeller(explanatory = exp.labs)) +
  labs(
    title = "Plot 3. Responses Outside of Average",
    x = NULL,
